...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: _buildDarkModeButton(),
  ...
  Widget _buildDarkModeButton() {
    return FloatingActionButton(
      ...
      backgroundColor: _darkMode
          ...
          : Color.fromARGB(255, 96, 162, 249),
      child: Icon(_darkMode ? Icons.dark_mode : Icons.light_mode,
          color: _darkMode ? Colors.black : Color.fromARGB(255, 255, 255, 255)),
    );
  }
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: [
            Color.fromARGB(255, 28, 94, 224).withOpacity(0.2),
